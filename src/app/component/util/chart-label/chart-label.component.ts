...
import { BarOrientation, formatLabel } from '@swimlane/ngx-charts';

@Component({
  // eslint-disable-next-line @angular-eslint/component-selector
  selector: 'g[ngx-bar-label]',
  templateUrl: './chart-label.component.html',
  styleUrls: ['./chart-label.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ChartLabelComponent implements OnChanges, AfterViewInit {
  @Input() value;
  ...
  update(): void {
    ...
    this.formatedValue = this.data.type;
